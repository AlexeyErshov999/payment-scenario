...
<template>
  <div class="card" :class="{ 'card--has-shadow': hasShadow }">
...
.card {
  ...
  &--has-shadow {
    box-shadow: 0 4px 16px $gray-medium;
  }

  @media (min-width: 640px) {
    padding: $padding-vertical-form $padding-horizontal-form;
    max-width: 28rem;
  }
